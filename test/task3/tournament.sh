...
timeout -s SIGINT 1800 ./tu-aca-project/test/task3/run.sh TournamentBP scripts/facesim/facesim_1c_simsmall > results/TournamentBP/logs/facesim.txt 2>&1
...
timeout -s SIGINT 1800 ./tu-aca-project/test/task3/run.sh TournamentBP scripts/swaptions/swaptions_1c_simsmall > results/TournamentBP/logs/swaptions.txt 2>&1
mv m5out/stats.txt results/TournamentBP/results/swaptions/

mkdir results/TournamentBP/results/vips
timeout -s SIGINT 1800 ./tu-aca-project/test/task3/run.sh TournamentBP scripts/vips/vips_1c_simsmall > results/TournamentBP/logs/vips.txt 2>&1
...
timeout -s SIGINT 1800 ./tu-aca-project/test/task3/run.sh TournamentBP scripts/rtview/rtview_1c_simsmall > results/TournamentBP/logs/rtview.txt 2>&1
