...
timeout -s SIGINT 1800 ./tu-aca-project/test/task3/run.sh BiModeBP scripts/facesim/facesim_1c_simsmall > results/BiModeBP/logs/facesim.txt 2>&1
...
timeout -s SIGINT 1800 ./tu-aca-project/test/task3/run.sh BiModeBP scripts/swaptions/swaptions_1c_simsmall > results/BiModeBP/logs/swaptions.txt 2>&1
mv m5out/stats.txt results/BiModeBP/results/swaptions/

mkdir results/BiModeBP/results/vips
timeout -s SIGINT 1800 ./tu-aca-project/test/task3/run.sh BiModeBP scripts/vips/vips_1c_simsmall > results/BiModeBP/logs/vips.txt 2>&1
...
timeout -s SIGINT 1800 ./tu-aca-project/test/task3/run.sh BiModeBP scripts/rtview/rtview_1c_simsmall > results/BiModeBP/logs/rtview.txt 2>&1
