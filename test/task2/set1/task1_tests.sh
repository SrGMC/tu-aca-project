...
# Run 1
mv ./tu-aca-project/test/task2/set1/assets/1.py ./src/cpu/pred/BranchPredictor.py
mkdir results/run1
...
# Run 2
mv ./tu-aca-project/test/task2/set1/assets/2.py ./src/cpu/pred/BranchPredictor.py
mkdir results/run2
...
# Run 3
mv ./tu-aca-project/test/task2/set1/assets/3.py ./src/cpu/pred/BranchPredictor.py
mkdir results/run3
...
# Run 4
mv ./tu-aca-project/test/task2/set1/assets/4.py ./src/cpu/pred/BranchPredictor.py
mkdir results/run4
...
# Run 5
mv ./tu-aca-project/test/task2/set1/assets/5.py ./src/cpu/pred/BranchPredictor.py
mkdir results/run5
...
# Run 6
mv ./tu-aca-project/test/task2/set1/assets/6.py ./src/cpu/pred/BranchPredictor.py
mkdir results/run6
